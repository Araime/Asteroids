...
void UserInterface::InitUI(Game& game)
{
	...
	survivalTimeText.InitText(game.titleFont, TIMER_TEXT_SIZE, sf::Color::White);
	survivalTimeText.UpdateText("0:00");
	survivalTimeText.txt.setPosition(TIMER_XCOR, TIMER_YCOR); // Set the position for the timer
